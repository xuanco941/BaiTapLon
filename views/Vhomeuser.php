...
<body>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li>
                            <div class="input-group">
                                ...
                                <a class="btn btn-warning" href="#" role="button">search</a>
                            </div>
                        </li>
                    </ul>
                    <ul class="navbar-nav ms-auto">
                        ...
                        <a class="btn btn-secondary" href="#" role="button"><i class="fas fa-cart-plus"></i>cart</a>
                            <a class="btn btn-warning" href="#" role="button">Sign in</a>
                            <a class="btn btn-warning" href="#" role="button">Sign up</a>
                        </li>
  ...
  <div class="card">
    <img class="card-img-top" src="image/damcuoi.jpg" alt="Card image cap">
    <div class="card-body">
      ...
      <a href="#" class="btn btn-warning">Xem chi tiết</a>
        ...
        <footer class="bg-light text-center text-lg-start">
            <div class="text-center p-3" style="background-color: #e3f2fd;">
                © 2020 Copyright:
                <a class="text-info" href="https://mdbootstrap.com/">TLU</a>
            </div>
